...
//		AttackLog			m_kAttackLog;
	...
	public:
		...
		void				BroadcastTargetAffectPacket();
	#endif
		void				ClearTarget();
		void				CheckTarget();
...
#ifdef ENABLE_MOB_MOVMENT_CONTROLL
		void				StartReturnRecoveryEvent();
		void				StopReturnRecoveryEvent();
#endif
...
#ifdef ENABLE_MOB_MOVMENT_CONTROLL
		LPEVENT				m_pkReturnRecoveryEvent;
#endif

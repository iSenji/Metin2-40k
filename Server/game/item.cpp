...
void CItem::ModifyPoints(bool bAdd)
{
	...
	for (int i = 0; i < ITEM_APPLY_MAX_NUM; ++i)
	{
		...
		int rarity = int(GetSocket(ITEM_RARITY_SOCKET));
			
		switch (GetType())
		{
			case ITEM_ARMOR:
			case ITEM_WEAPON:
				value = value * RARITY_VALUES[rarity];
		}
#endif	
...
void CItem::ClearMountAttributeAndAffect()
{
	...
	ch->ChatPacket(CHAT_TYPE_INFO, "ClearMountAttributeAndAffect");

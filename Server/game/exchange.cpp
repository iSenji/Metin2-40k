...
bool CExchange::CheckSpace()
{
	...
	static CGrid s_grid3(5, INVENTORY_MAX_NUM/5 / 5); // inven page 2
	static CGrid s_grid4(5, INVENTORY_MAX_NUM/5 / 5); // inven page 2
	static CGrid s_grid5(5, INVENTORY_MAX_NUM/5 / 5); // inven page 2

...
class InventoryWindow(ui.ScriptWindow):
	...
	def __LoadWindow(self):
		...
		wndItem.OnMouseOverIn = ui.__mem_func__(self.__Teszt2)
		wndEquip.OnMouseOverIn = ui.__mem_func__(self.__Teszt)
		wndCostume.OnMouseOverIn = ui.__mem_func__(self.__Teszt)
		wndSecondary.OnMouseOverIn = ui.__mem_func__(self.__Teszt)
		wndTalisman.OnMouseOverIn = ui.__mem_func__(self.__Teszt)
		wndEffect.OnMouseOverIn = ui.__mem_func__(self.__Teszt)
		## Item
	...
	def __Teszt(self):
		self.isCostumFocus = 1
	def __Teszt2(self):
		self.isCostumFocus = 0
	...
	def OnRunMouseWheel(self, nLen):
		if nLen < 0:
			if self.isCostumFocus == 1:
				if self.costumePageIndex < 4:
					self.SetEquipmentPage(self.costumePageIndex + 1)
			else:
	...
	def RefreshEquipSlotWindow(self):
		...
		for i in xrange(player.EQUIPMENT_PAGE_COUNT):
			...
			self.wndEquip.SetItemSlot(slotNumber, getItemVNum(slotNumber), 0)
		slotNumber = item.EQUIPMENT_BELT
		itemCount = getItemCount(slotNumber)
		if itemCount <= 1:
				itemCount = 0
		self.wndEquip.SetItemSlot(slotNumber, getItemVNum(slotNumber), 0)

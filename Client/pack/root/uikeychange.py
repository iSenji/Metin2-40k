...
class KeyChangeWindow(ui.ScriptWindow):
	...
	## KeySetting.txt ÆÄÀÏ ÀÐ¾î ¿Í¼­ ¼ÂÆÃ
	def LoadKeyInfo(self):
		...
		if count > 0:
			...
			## ¸¸¾à ½ºÅ©¸°¼¦ ½½·Ô¿¡ ´Ù¸¥ Å°°¡ ÀÖ´Ù¸é ÃÊ±âÈ­ ÇÏ°í ÀúÀå.
	...
	## =================== Å° ¼ÂÆÃ¹× º¯°æ¿¡ ÇÊ¿äÇÑ Dick µé ¼ÂÆÃ ºÎºÐ ===================

	def __BuildKeyInfo(self, fileable):
		## ½ÇÁ¦ UI Ç¥±âµÇ°í, ÀÛµ¿µÉ °Í Base
		KeyUiInfoDick = {}
		## ±âº»µ¿ÀÛ
		...
		## ÃÊ±âÈ­¿¡ ÇÊ¿äÇØ¼­ µû·Î ÇÏ³ª´õ ÀúÀåÇØµÒ.
		for i in xrange(self.KeySlotMax):
	...
	## =================== Å° ¼ÂÆÃ¹Î º¯°æ¿¡ ÇÊ¿äÇÑ Dick µé ¼ÂÆÃ ºÎºÐ ===================
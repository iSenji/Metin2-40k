...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ADVANCED_BLOCK_DODGE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ADVANCED_BLOCK_DODGE", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_COSTUME_WEAPON", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_COSTUME_WEAPON", 0);
#endif

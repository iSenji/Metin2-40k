...
;
	...
	const DWORD c_Equipment_Ring3 = c_New_Equipment_Start + 2;
	const DWORD c_Equipment_Belt  = c_New_Equipment_Start + 3;;
#endif
...
enum
{
#ifndef ENABLE_RARITY_SYSTEM
	ITEM_SOCKET_SLOT_MAX_NUM = 3,
#else
	ITEM_SOCKET_SLOT_MAX_NUM = 7,
	ITEM_METIN_SOCKET_SLOT_MAX_NUM = 3,
#endif

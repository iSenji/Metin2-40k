...
const bool CPlayerSettingsModule::LoadInitData()
{
	...
	static const std::vector<TEffect> m_vecEffectData =
	{
		...
		{ pkBase.EFFECT_DAMAGE_PENETRATE, "", "d:/ymir work/effect/affect/damagevalue/critical.mse" },
		...
		{ pkBase.EFFECT_AGGREGATE_MONSTER, "", "d:/ymir work/effect/aggregate/aggregate_monster.mse" },
#endif
#ifdef ENABLE_UPGRADE_EFFECT
		{ pkBase.EFFECT_UPSUCCESS, "", "d:/ymir work/effect/etc/blacksmith/up_ok.mse" },
		{ pkBase.EFFECT_UPFAILED, "", "d:/ymir work/effect/etc/blacksmith/up_failed.mse" },
#endif
...
#ifdef ENABLE_ACCE_SYSTEM
		{ pkBase.EFFECT_REFINED + 22, "Bip01", "d:/ymir work/pc/common/effect/armor/acc_01.mse" },
#endif
...
{
	CPlayerSettingsModule::LoadGameAssassin(CPlayerSettingsModule::RACE_ASSASSIN_W, (char*)"d:/ymir work/pc/assassin/");
	CPlayerSettingsModule::LoadGameAssassin(CPlayerSettingsModule::RACE_ASSASSIN_M, (char*)"d:/ymir work/pc2/assassin/");
	return Py_BuildNone();
}

PyObject* cpsmLoadGameSura(PyObject* poSelf, PyObject* poArgs)
{
	CPlayerSettingsModule::LoadGameSura(CPlayerSettingsModule::RACE_SURA_M, (char*)"d:/ymir work/pc/sura/");
	CPlayerSettingsModule::LoadGameSura(CPlayerSettingsModule::RACE_SURA_W, (char*)"d:/ymir work/pc2/sura/");
	return Py_BuildNone();
}

PyObject* cpsmLoadGameShaman(PyObject* poSelf, PyObject* poArgs)
{
	CPlayerSettingsModule::LoadGameShaman(CPlayerSettingsModule::RACE_SHAMAN_W, (char*)"d:/ymir work/pc/shaman/");
	CPlayerSettingsModule::LoadGameShaman(CPlayerSettingsModule::RACE_SHAMAN_M, (char*)"d:/ymir work/pc2/shaman/");
	return Py_BuildNone();
}
...
{
	CPlayerSettingsModule::LoadGameWolfman(CPlayerSettingsModule::RACE_WOLFMAN_M, (char*)"d:/ymir work/pc3/wolfman/");
	return Py_BuildNone();
}
#endif // ENABLE_WOLFMAN_CHARACTER

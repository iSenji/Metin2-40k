...
{
#ifdef BOSS_SYSTEM_FALLBACK
	const CPythonNonPlayer::TMobTable* pkMobTable = CPythonNonPlayer::instance().GetTable(vnum);
	if (pkMobTable && pkMobTable->bRank == CPythonNonPlayer::MOB_RANK_BOSS)
		return true;
#endif
